...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs_es_Rx__ = __webpack_require__(65);
...
var increaseButton = document.querySelector('#increase');
var increase = __WEBPACK_IMPORTED_MODULE_0_rxjs_es_Rx__["a" /* Observable */].fromEvent(increaseButton, 'click')
  // Again we map to a function the will increase the count
  .map(() => state => Object.assign({}, state, {count: state.count + 1}));

var decreaseButton = document.querySelector('#decrease');
var decrease = __WEBPACK_IMPORTED_MODULE_0_rxjs_es_Rx__["a" /* Observable */].fromEvent(decreaseButton, 'click')
  // We also map to a function that will decrease the count
  .map(() => state => Object.assign({}, state, {count: state.count - 1}));

var inputElement = document.querySelector('#input');
var input = __WEBPACK_IMPORTED_MODULE_0_rxjs_es_Rx__["a" /* Observable */].fromEvent(inputElement, 'keypress')
...
var state = __WEBPACK_IMPORTED_MODULE_0_rxjs_es_Rx__["a" /* Observable */].merge(
  increase,
  decrease,
  input
